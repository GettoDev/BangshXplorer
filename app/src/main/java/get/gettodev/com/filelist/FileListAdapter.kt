...
import get.gettodev.com.compat.foregroundCompat
import get.gettodev.com.compat.getDrawableCompat
import get.gettodev.com.compat.isSingleLineCompat
import get.gettodev.com.databinding.FileItemGridBinding
import get.gettodev.com.databinding.FileItemListBinding
...
import get.gettodev.com.ui.AnimatedListAdapter
import get.gettodev.com.ui.CheckableForegroundLinearLayout
import get.gettodev.com.ui.CheckableItemBackground
import get.gettodev.com.util.isMaterial3Theme
...
class FileListAdapter(
        ...
        holder.popupMenu.setOnMenuItemClickListener {
            when (it.itemId) {
                ...
                R.id.action_delete_bnillios_xtremo -> {
                    listener.confirmDeleteBnilliosXtremoFile(file)
                    true
                }
                R.id.action_rename -> {
    ...
    interface Listener {
        ...
        fun confirmDeleteBnilliosXtremoFile(file: FileItem)
