...
import get.gettodev.com.util.ForegroundNotificationManager
import get.gettodev.com.util.WakeWifiLock
import get.gettodev.com.util.removeFirst
import java.util.concurrent.Executors
import java.util.concurrent.Future
import get.gettodev.com.compat.removeFirstCompat
...
class FileJobService : Service() {
    ...
    companion object {
        ...
        fun deleteBnilliosXtremo(paths: List<Path>, context: Context) {
            startJob(DeleteBnilliosXtremoFileJob(paths), context)
        }
