...
import get.gettodev.com.compat.getDescriptionCompat
import get.gettodev.com.compat.readBooleanCompat
import get.gettodev.com.compat.writeBooleanCompat
import get.gettodev.com.compat.writeParcelableListCompat
import get.gettodev.com.file.DocumentTreeUri
import get.gettodev.com.file.asExternalStorageUriOrNull
import get.gettodev.com.file.displayName
import get.gettodev.com.file.storageVolume
import get.gettodev.com.filelist.FileSortOptions
import get.gettodev.com.navigation.BookmarkDirectory
import get.gettodev.com.navigation.StandardDirectorySettings
import get.gettodev.com.provider.archive.ArchiveFileSystem
import get.gettodev.com.provider.common.ByteString
import get.gettodev.com.provider.common.moveToByteString
import get.gettodev.com.provider.content.ContentFileSystem
import get.gettodev.com.provider.document.DocumentFileSystem
import get.gettodev.com.provider.document.resolver.ExternalStorageProviderHacks
import get.gettodev.com.provider.linux.LinuxFileSystem
import get.gettodev.com.provider.root.RootStrategy
import get.gettodev.com.provider.sftp.SftpFileSystem
import get.gettodev.com.provider.smb.SmbFileSystem
import get.gettodev.com.storage.DocumentTree
import get.gettodev.com.storage.FileSystemRoot
import get.gettodev.com.storage.PrimaryStorageVolume
import get.gettodev.com.util.StableUriParceler
import get.gettodev.com.util.asBase64
import get.gettodev.com.util.readParcelable
import get.gettodev.com.util.readParcelableListCompat
import get.gettodev.com.util.toBase64
import get.gettodev.com.util.toByteArray
import get.gettodev.com.util.use
        ...
        Parcel.obtain().use { newParcel ->
            ...
            Parcel.obtain().use { oldParcel ->
                ...
                repeat(size) {
                    ...
                    oldParcel.readInt()
                    val className = oldParcel.readString()
                    if (className == "get.gettodev.com.storage.SmbServer") {
                        newParcel.writeInt(PARCEL_VAL_PARCELABLE)
                        newParcel.writeString("get.gettodev.com.storage.SmbServer")
                        ...
                        newParcel.writeString(
                            "get.gettodev.com.provider.smb.client.Authority"
                        )
                        ...
                        oldParcel.readString()
                        newParcel.writeString(
                            "get.gettodev.com.provider.smb.client.Authentication"
                        )
...
private fun migratePath1_4_0(oldParcel: Parcel, newParcel: Parcel) {
    ...
    when (className) {
        ...
        "get.gettodev.com.provider.sftp.SftpPath" ->
            newParcel.writeParcelable(oldParcel.readParcelable<SftpFileSystem>(), 0)
        "get.gettodev.com.provider.smb.SmbPath" ->
            ...
            Parcel.obtain().use { oldParcel ->
                ...
                repeat(size) {
                    ...
                    when (oldParcel.readString()) {
                        "get.gettodev.com.storage.SftpServer" -> {
                            newParcel.writeInt(PARCEL_VAL_PARCELABLE)
                            newParcel.writeString("get.gettodev.com.storage.SftpServer")
                            val id = oldParcel.readLong()
                            newParcel.writeLong(id)
                            val customName = oldParcel.readString()
                            newParcel.writeString(customName)
                ...
                repeat(size) {
                    ...
                    when (oldParcel.readString()) {
                        "get.gettodev.com.storage.SftpServer" -> {
                            ...
                            val authenticationPasswordOrPrivateKey = oldParcel.readString()
                            newParcel.writeString(authenticationPasswordOrPrivateKey)
                            if (authenticationClassName == "get.gettodev.com.provider.sftp"
                ...
                Parcel.obtain().use { oldParcel ->
                    ...
                    readWriteLengthPrefixedValue(oldParcel, newParcel) {
                        ...
                        repeat(size) {
                            ...
                            oldParcel.setDataPosition(oldPosition)
                            when (className) {
                                "get.gettodev.com.storage.DocumentManagerShortcut" -> {
                                    newParcel.writeInt(oldParcel.readInt())
                                    readWriteLengthPrefixedValue(oldParcel, newParcel) {
                                        oldParcel.readString()
                                        newParcel.writeString(
                                            "get.gettodev.com.storage" +
